...
После создания файл будет помещен в директорию `./configs` внутри рабочей директории приложения.
...
1. Простой вызов с указанием пути к конфигурационному файлу
```
$ node bin/blc run -c ./configs/my.site.com.js
```

2. Анализ сайта `http://my.another.site.com` c использованием конфигурационного файла для сайта `my.site.com`.
```
$ node bin/blc run -c ./configs/my.site.com.js -u http://my.another.site.com
```

3. Использование параметров запросов отличных от указаных в конфигурационном файле.
```
$ node bin/blc run -c ./configs/my.site.com.js -cc 50 -rt 10000 -rra 20
```

4. Выборочный анализ страницы `/foo/bar` сайта `http://my.site.com`.
```
